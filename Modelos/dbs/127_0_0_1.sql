...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-02-2025 a las 17:09:06
...
(131, 'Kwai', 'Lees', '', 'H', '2025-02-14', 'KwaiLee@si2024', '64131131', 'Lee', 'd9b1d7db4cd6e70935368a1efb10e377', 'N'),
...
(249, 'Paolo', 'Accortis', 'Kennedys', 'M', '2025-02-14', 'PaoloAccorti@2si2024.com', '', 'accorti', '2e482c576c15ae096fd4a305532b1ed6', 'N'),
...
(517, '', '', '', 'H', '2024-12-04', '', '', '', 'd41d8cd98f00b204e9800998ecf8427e', 'N'),
...
(538, 'asdfasdfasd', 'fasdfasdfasdfas', 'dfasdfasdfasdf', 'H', '2025-02-14', 'KwaiLeeasdfasdfasdf@gmail.com', '111222333', 'asdfasdfasdfasdfasdf', 'a95c530a7af5f492a74499e70578d150', 'S');
...
--
ALTER TABLE `usuarios`
  MODIFY `id_Usuario` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=539;
...
('root', '[{\"db\":\"di2024\",\"table\":\"roles\"},{\"db\":\"di2024\",\"table\":\"permisos_roles\"},{\"db\":\"di2024\",\"table\":\"permisos\"},{\"db\":\"di2024\",\"table\":\"roles_usuarios\"},{\"db\":\"di2024\",\"table\":\"usuarios\"},{\"db\":\"di2024\",\"table\":\"menu\"},{\"db\":\"di2024\",\"table\":\"permisos_usuarios\"},{\"db\":\"di2024\",\"table\":\"rolesusuarios\"},{\"db\":\"mysql\",\"table\":\"user\"},{\"db\":\"di2024\",\"table\":\"rol_permiso\"}]');
...
('root', 'di2024', 'usuarios', '{\"sorted_col\":\"`usuarios`.`id_Usuario` ASC\"}', '2025-02-14 17:12:53');
...
('root', '2025-02-17 16:08:35', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
